...
local InactiveStatusHL = {
	fg = vim.api.nvim_exec("highlight VertSplit", true):match("guifg=(#%d+)") or "#444444",
	bg = vim.api.nvim_exec("highlight VertSplit", true):match("guibg=(#%d+)") or "#1E1E1E",
	style = vim.api.nvim_exec("highlight VertSplit", true):match("gui=(#%d+)") or "",
}
